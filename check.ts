//This is where i want to import the class i just created 
...
//     let digitElement = document.createElement('button', { is: digit });
...
//This is My Js code which i want to convert to ts
